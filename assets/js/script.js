...
(function ($) {
    ...
    02. Shop Page Grid Setting Js
    ==========================**/
    const allGridClasses = "row-cols-xxl-5 row-cols-xxl-4 row-cols-xl-4 row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-2 list-style";
    ...
    $('.three-grid').on('click', function (e) {
        $(".product-list-section").removeClass(allGridClasses)
            .addClass("row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-2");
    });

    $('.grid-btn').on('click', function (e) {
        $(".product-list-section").removeClass(allGridClasses)
            .addClass("row-cols-xl-4 row-cols-lg-2 row-cols-md-3 row-cols-2");
    });

    $('.five-grid').on('click', function (e) {
        $(".product-list-section").removeClass(allGridClasses)
            .addClass("row-cols-xxl-5 row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-2");
    });
...
$(document).ready(function () {
    ...
    $('.btn-cart').on("click", function () {
        $('.header-cart').addClass('cart-jump');
        setTimeout(function () {
...
$(window).on("load resize", function () {
    ...
    $(document).on("click", function (e) {
        if (!$(e.target).closest(".search-full, .search-box").length) {
...
/*=====================
   26. Divitag Slider Js
   ==========================*/
if ($('.divitag-slider').length > 0) {
    $('.divitag-slider').slick({
        dots: true,
        arrows: true,
        infinite: true,
        speed: 600,
        ...
        prevArrow: `
            <button type="button" class="slick-prev custom-arrow" aria-label="Previous">
                <span aria-label="Previous"><svg width="12" height="22" viewBox="0 0 12 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M11 21L1 11L11 1" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></span>
            </button>`,
        nextArrow: `
            <button type="button" class="slick-next custom-arrow" aria-label="Next">
                <span aria-label="Next"><svg width="12" height="22" viewBox="0 0 12 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 21L11 11L1 1" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg></span>
            </button>`,
        responsive: [
            {
                breakpoint: 992,
